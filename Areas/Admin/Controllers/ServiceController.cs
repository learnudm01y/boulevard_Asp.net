                    ...
                    if (Request.Files.Count > 0)
                    {
                        ...
                        if (fileExtension == ".xls" || fileExtension == ".xlsx")
                        {
                            ...
                            else if (model.fCatagoryKey == "DD501B2D-FE22-4C31-B340-1B4237FAB5CC".ToLower()) // Replace with actual GUID
                            {
                                ...
                                // Safe column reader - returns "" if column doesn't exist in this Excel
                                Func<DataRow, string, string> safeRead = (row, col) =>
                                    dataTable.Columns.Contains(col) ? row[col]?.ToString() ?? "" : "";

                                TempService tempService = new TempService();

                                tempService.Name = safeRead(dataTable.Rows[0], "RealState Name");
                                tempService.NameAr = safeRead(dataTable.Rows[0], "RealState Name Arabic");
                                tempService.Description = safeRead(dataTable.Rows[0], "Description-html");
                                tempService.DescriptionAr = safeRead(dataTable.Rows[0], "Description Arabic-html");
                                tempService.ServiceHour = safeRead(dataTable.Rows[0], "ServiceHour");
                                tempService.Category = safeRead(dataTable.Rows[0], "Category");
                                tempService.CategoryArabic = safeRead(dataTable.Rows[0], "Category arabic");
                                tempService.CategoryImage = safeRead(dataTable.Rows[0], "Category Image");
                                tempService.Country = safeRead(dataTable.Rows[0], "Country Name");
                                tempService.City = safeRead(dataTable.Rows[0], "City Name");
                                tempService.Address = safeRead(dataTable.Rows[0], "Address");
                                tempService.AboutUs = safeRead(dataTable.Rows[0], "AboutUs");
                                tempService.AboutUsAr = safeRead(dataTable.Rows[0], "About us Arabic");
                                tempService.Languages = safeRead(dataTable.Rows[0], "Languages");
                                tempService.Images = safeRead(dataTable.Rows[0], "Images");
                                tempService.Latitute = safeRead(dataTable.Rows[0], "Latitute");
                                tempService.Longitute = safeRead(dataTable.Rows[0], "Longitute");

                                // Real Estate specific properties
                                tempService.ServiceTypeName = safeRead(dataTable.Rows[0], "Service Type Name");
                                tempService.ServiceTypeNameAr = safeRead(dataTable.Rows[0], "Service Type Name Arabic");
                                tempService.PersoneQuantity = safeRead(dataTable.Rows[0], "PersoneQuantity");
                                tempService.AdultQuantity = safeRead(dataTable.Rows[0], "AdultQuantity");
                                tempService.ChildrenQuantity = safeRead(dataTable.Rows[0], "ChildrenQuantity");
                                tempService.TypeDescription = safeRead(dataTable.Rows[0], "Description");
                                tempService.TypeDescriptionAr = safeRead(dataTable.Rows[0], "Description Arabic");
                                tempService.Size = safeRead(dataTable.Rows[0], "Size");
                                tempService.SizeAr = safeRead(dataTable.Rows[0], "Size Arabic");
                                tempService.TypeImage = safeRead(dataTable.Rows[0], "Images");
                                tempService.TypePrice = safeRead(dataTable.Rows[0], "Price");
                                tempService.PaymentType = safeRead(dataTable.Rows[0], "Payment Type");
                                tempService.ServiceTypeCategory = safeRead(dataTable.Rows[0], "Service Type Category");
                                tempService.ServiceTypeSubCategory = safeRead(dataTable.Rows[0], "Service Type Sub Category");
                                tempService.PropertyType = safeRead(dataTable.Rows[0], "Property Type");
                                tempService.PropertyTypeArabic = safeRead(dataTable.Rows[0], "Property Type Arabic");
                                tempService.PropertyRefNo = safeRead(dataTable.Rows[0], "Ref No");
                                tempService.PropertyPurpose = safeRead(dataTable.Rows[0], "Property Purpose");
                                tempService.Furnishing = safeRead(dataTable.Rows[0], "Furnishing");
                                tempService.FurnishingArabic = safeRead(dataTable.Rows[0], "Furnishing Arabic");
                                tempService.PropertyWhatsAppNo = safeRead(dataTable.Rows[0], "PropertyWhatsAppNo");
                                tempService.PropertyEmail = safeRead(dataTable.Rows[0], "Property email");
                                tempService.ExteriorDetails = safeRead(dataTable.Rows[0], "Exterior Details");
                                tempService.ExteriorDetailsArabic = safeRead(dataTable.Rows[0], "Exterior Details Arabic");
                                tempService.ExteriorImage = safeRead(dataTable.Rows[0], "Exterior Image");
                                tempService.InteriorDetails = safeRead(dataTable.Rows[0], "Interior Details");
                                tempService.InteriorDetailsArabic = safeRead(dataTable.Rows[0], "Interior Details Arabic");
                                tempService.InteriorImage = safeRead(dataTable.Rows[0], "Interior Image");
                                tempService.AmenitiesName = safeRead(dataTable.Rows[0], "Amenities Name");
                                tempService.AmenitiesNameArabic = safeRead(dataTable.Rows[0], "Amenities name arabic");
                                tempService.AmenitiesImage = safeRead(dataTable.Rows[0], "Amenitise Image");
                                tempService.AmenitiesFile = safeRead(dataTable.Rows[0], "Amenities File");
                                tempService.CloserPropertyName = safeRead(dataTable.Rows[0], "CloserProperty Name");
                                tempService.CloserPropertyNameArabic = safeRead(dataTable.Rows[0], "CloserProperty Name Arabic");
                                tempService.CloserPropertyLogo = safeRead(dataTable.Rows[0], "CloserProperty  Logo");
                                tempService.CloserPropertyFile = safeRead(dataTable.Rows[0], "CloserProperty File");
                                tempService.MaterialsName = safeRead(dataTable.Rows[0], "Materials name");
                                tempService.MaterialsNameArabic = safeRead(dataTable.Rows[0], "Materials Name Arabic");
                                tempService.MaterialsLogo = safeRead(dataTable.Rows[0], "Materials Logo");
                                tempService.MaterialsFile = safeRead(dataTable.Rows[0], "Materials File");
                                tempService.UtilityName = safeRead(dataTable.Rows[0], "Utility Name");
                                tempService.UtilityNameArabic = safeRead(dataTable.Rows[0], "Utility Name Arabic");
                                tempService.UtilityLogo = safeRead(dataTable.Rows[0], "Utility Logo");
                                tempService.UtilityFile = safeRead(dataTable.Rows[0], "Utility File");
                                tempService.Video = safeRead(dataTable.Rows[0], "Video");
                                #endregion
                                ...
                                using (XmlWriter writer = new XmlTextWriter(new StringWriter(xmlStore)))
                                {
                                    ...
                                    foreach (DataRow objDataRow in dataTable.Rows)
                                    {
                                        ...
                                        // Read each row's data from objDataRow
                                        data.Name = safeRead(objDataRow, "RealState Name");
                                        data.NameAr = safeRead(objDataRow, "RealState Name Arabic");
                                        data.Description = safeRead(objDataRow, "Description-html");
                                        data.DescriptionAr = safeRead(objDataRow, "Description Arabic-html");
                                        data.ServiceHour = safeRead(objDataRow, "ServiceHour");
                                        data.Category = safeRead(objDataRow, "Category");
                                        data.CategoryArabic = safeRead(objDataRow, "Category arabic");
                                        data.CategoryImage = safeRead(objDataRow, "Category Image");
                                        data.Country = safeRead(objDataRow, "Country Name");
                                        data.City = safeRead(objDataRow, "City Name");
                                        data.Address = safeRead(objDataRow, "Address");
                                        data.AboutUs = safeRead(objDataRow, "AboutUs");
                                        data.AboutUsAr = safeRead(objDataRow, "About us Arabic");
                                        data.Languages = safeRead(objDataRow, "Languages");
                                        data.Images = safeRead(objDataRow, "Images");
                                        data.Latitute = safeRead(objDataRow, "Latitute");
                                        data.Longitute = safeRead(objDataRow, "Longitute");
                                        data.ServiceTypeName = safeRead(objDataRow, "Service Type Name");
                                        data.ServiceTypeNameAr = safeRead(objDataRow, "Service Type Name Arabic");
                                        data.PersoneQuantity = safeRead(objDataRow, "PersoneQuantity");
                                        data.AdultQuantity = safeRead(objDataRow, "AdultQuantity");
                                        data.ChildrenQuantity = safeRead(objDataRow, "ChildrenQuantity");
                                        data.TypeDescription = safeRead(objDataRow, "Description");
                                        data.TypeDescriptionAr = safeRead(objDataRow, "Description Arabic");
                                        data.Size = safeRead(objDataRow, "Size");
                                        data.SizeAr = safeRead(objDataRow, "Size Arabic");
                                        data.TypeImage = safeRead(objDataRow, "Images");
                                        data.TypePrice = safeRead(objDataRow, "Price");
                                        data.PaymentType = safeRead(objDataRow, "Payment Type");
                                        data.ServiceTypeCategory = safeRead(objDataRow, "Service Type Category");
                                        data.ServiceTypeSubCategory = safeRead(objDataRow, "Service Type Sub Category");
                                        data.PropertyType = safeRead(objDataRow, "Property Type");
                                        data.PropertyTypeArabic = safeRead(objDataRow, "Property Type Arabic");
                                        data.PropertyRefNo = safeRead(objDataRow, "Ref No");
                                        data.PropertyPurpose = safeRead(objDataRow, "Property Purpose");
                                        data.Furnishing = safeRead(objDataRow, "Furnishing");
                                        data.FurnishingArabic = safeRead(objDataRow, "Furnishing Arabic");
                                        data.PropertyWhatsAppNo = safeRead(objDataRow, "PropertyWhatsAppNo");
                                        data.PropertyEmail = safeRead(objDataRow, "Property email");
                                        data.ExteriorDetails = safeRead(objDataRow, "Exterior Details");
                                        data.ExteriorDetailsArabic = safeRead(objDataRow, "Exterior Details Arabic");
                                        data.ExteriorImage = safeRead(objDataRow, "Exterior Image");
                                        data.InteriorDetails = safeRead(objDataRow, "Interior Details");
                                        data.InteriorDetailsArabic = safeRead(objDataRow, "Interior Details Arabic");
                                        data.InteriorImage = safeRead(objDataRow, "Interior Image");
                                        data.AmenitiesName = safeRead(objDataRow, "Amenities Name");
                                        data.AmenitiesNameArabic = safeRead(objDataRow, "Amenities name arabic");
                                        data.AmenitiesImage = safeRead(objDataRow, "Amenitise Image");
                                        data.AmenitiesFile = safeRead(objDataRow, "Amenities File");
                                        data.CloserPropertyName = safeRead(objDataRow, "CloserProperty Name");
                                        data.CloserPropertyNameArabic = safeRead(objDataRow, "CloserProperty Name Arabic");
                                        data.CloserPropertyLogo = safeRead(objDataRow, "CloserProperty  Logo");
                                        data.CloserPropertyFile = safeRead(objDataRow, "CloserProperty File");
                                        data.MaterialsName = safeRead(objDataRow, "Materials name");
                                        data.MaterialsNameArabic = safeRead(objDataRow, "Materials Name Arabic");
                                        data.MaterialsLogo = safeRead(objDataRow, "Materials Logo");
                                        data.MaterialsFile = safeRead(objDataRow, "Materials File");
                                        data.UtilityName = safeRead(objDataRow, "Utility Name");
                                        data.UtilityNameArabic = safeRead(objDataRow, "Utility Name Arabic");
                                        data.UtilityLogo = safeRead(objDataRow, "Utility Logo");
                                        data.UtilityFile = safeRead(objDataRow, "Utility File");
                                        data.Video = safeRead(objDataRow, "Video");
                                        data.ExcelCount = counter;
                                        ...
                                        writer.WriteAttributeString("description", data.Description ?? "");
                                        writer.WriteAttributeString("descriptionAr", data.DescriptionAr ?? "");
                                        writer.WriteAttributeString("serviceHour", data.ServiceHour ?? "");
                                        writer.WriteAttributeString("category", data.Category ?? "");
                                        writer.WriteAttributeString("categoryAr", data.CategoryArabic ?? "");
                                        writer.WriteAttributeString("categoryImage", data.CategoryImage ?? "");
                                        writer.WriteAttributeString("country", data.Country ?? "");
                                        writer.WriteAttributeString("city", data.City ?? "");
                                        writer.WriteAttributeString("address", data.Address ?? "");
                                        ...
                                        writer.WriteAttributeString("serviceTypeNameAr", data.ServiceTypeNameAr ?? "");
                                        writer.WriteAttributeString("personQuantity", data.PersoneQuantity ?? "");
                                        writer.WriteAttributeString("adultQuantity", data.AdultQuantity ?? "");
                                        writer.WriteAttributeString("childrenQuantity", data.ChildrenQuantity ?? "");
                                        writer.WriteAttributeString("typeDescription", data.TypeDescription ?? "");
                                        writer.WriteAttributeString("typeDescriptionAr", data.TypeDescriptionAr ?? "");
                                        writer.WriteAttributeString("size", data.Size ?? "");
                                        writer.WriteAttributeString("sizeAr", data.SizeAr ?? "");
                                        writer.WriteAttributeString("typeImage", data.TypeImage ?? "");
                                        writer.WriteAttributeString("typePrice", data.TypePrice ?? "");
                                        writer.WriteAttributeString("paymentType", data.PaymentType ?? "");
                                        writer.WriteAttributeString("serviceTypeCategory", data.ServiceTypeCategory ?? "");
                                        writer.WriteAttributeString("serviceTypeSubCategory", data.ServiceTypeSubCategory ?? "");
                                        writer.WriteAttributeString("propertyType", data.PropertyType ?? "");
                                        writer.WriteAttributeString("propertyTypeAr", data.PropertyTypeArabic ?? "");
                                        writer.WriteAttributeString("propertyRefNo", data.PropertyRefNo ?? "");
                                        writer.WriteAttributeString("propertyPurpose", data.PropertyPurpose ?? "");
                                        writer.WriteAttributeString("furnishing", data.Furnishing ?? "");
                                        writer.WriteAttributeString("furnishingAr", data.FurnishingArabic ?? "");
                                        writer.WriteAttributeString("propertyWhatsAppNo", data.PropertyWhatsAppNo ?? "");
                                        writer.WriteAttributeString("propertyEmail", data.PropertyEmail ?? "");
                                        writer.WriteAttributeString("exteriorDetails", data.ExteriorDetails ?? "");
                                        writer.WriteAttributeString("exteriorDetailsAr", data.ExteriorDetailsArabic ?? "");
                                        writer.WriteAttributeString("exteriorImage", data.ExteriorImage ?? "");
                                        writer.WriteAttributeString("interiorDetails", data.InteriorDetails ?? "");
                                        writer.WriteAttributeString("interiorDetailsAr", data.InteriorDetailsArabic ?? "");
                                        writer.WriteAttributeString("interiorImage", data.InteriorImage ?? "");
                                        writer.WriteAttributeString("amenitiesName", data.AmenitiesName ?? "");
                                        writer.WriteAttributeString("amenitiesNameAr", data.AmenitiesNameArabic ?? "");
                                        writer.WriteAttributeString("amenitiesImage", data.AmenitiesImage ?? "");
                                        writer.WriteAttributeString("amenitiesFile", data.AmenitiesFile ?? "");
                                        writer.WriteAttributeString("closerPropertyName", data.CloserPropertyName ?? "");
                                        writer.WriteAttributeString("closerPropertyNameAr", data.CloserPropertyNameArabic ?? "");
                                        writer.WriteAttributeString("closerPropertyLogo", data.CloserPropertyLogo ?? "");
                                        writer.WriteAttributeString("closerPropertyFile", data.CloserPropertyFile ?? "");
                                        writer.WriteAttributeString("materialsName", data.MaterialsName ?? "");
                                        writer.WriteAttributeString("materialsNameAr", data.MaterialsNameArabic ?? "");
                                        writer.WriteAttributeString("materialsLogo", data.MaterialsLogo ?? "");
                                        writer.WriteAttributeString("materialsFile", data.MaterialsFile ?? "");
                                        writer.WriteAttributeString("utilityName", data.UtilityName ?? "");
                                        writer.WriteAttributeString("utilityNameAr", data.UtilityNameArabic ?? "");
                                        writer.WriteAttributeString("utilityLogo", data.UtilityLogo ?? "");
                                        writer.WriteAttributeString("utilityFile", data.UtilityFile ?? "");
                                        writer.WriteAttributeString("video", data.Video ?? "");
                                        writer.WriteAttributeString("excelCount", data.ExcelCount.ToString() ?? "0");
                                        writer.WriteEndElement();
                                    }
